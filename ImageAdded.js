...
const NOOFROWS=8;
const NOOFCOLUMNS=8;
const WIDTHOFEACHBLOCK=40;
const HEIGTHOFEACHBLOCK=40;
...
function drawSnake(){
    if(counter%2==0){
        c.drawImage(image,currentPosition[0][0]-WIDTHOFEACHBLOCK/2,currentPosition[0][1]-HEIGTHOFEACHBLOCK/2,WIDTHOFEACHBLOCK,HEIGTHOFEACHBLOCK);
    

    }
    else{
        c.drawImage(img,currentPosition[0][0]-WIDTHOFEACHBLOCK/2,currentPosition[0][1]-HEIGTHOFEACHBLOCK/2,WIDTHOFEACHBLOCK,HEIGTHOFEACHBLOCK);
...
var COLORSOFFOOD=['green','voilet','blue'];
...
var imageOfCoins=new Image();
imageOfCoins.src='coins.png';

function drawFood(){
    for(let i=0;i<foodArray.length;i++){
        c.drawImage(imageOfCoins, foodArray[i][0]-WIDTHOFEACHBLOCK/2,foodArray[i][1]-HEIGTHOFEACHBLOCK/2,WIDTHOFEACHBLOCK,HEIGTHOFEACHBLOCK);
        // if()
